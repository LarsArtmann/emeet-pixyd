...
func statusPanel(s webStatus) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if s.Online && s.Camera == pixy.StateTracking {
			...
			templ_7745c5c3_Err = trackingSegment("none", "None", s.TrackMode == pixy.TrackNone.String()).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
...
func cameraModeCard(mode string, endpoint string, name string, desc string, shortcut string, active bool, online bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Var33 := []any{"mode-card", "mode-" + mode, templ.KV("active", active)}
...
func audioSegment(mode string, label string, active bool, online bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Var41 := []any{"segment", templ.KV("active", active)}
...
func trackingSegment(variant, label string, active bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Var47 := []any{"segment", templ.KV("active", active)}
