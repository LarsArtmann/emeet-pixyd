...
*Point-in-time snapshot — goes stale. Section (f) is HARVEST input for a future docs-health run; items 1–3 are the unblock set for the largest chunk of the table.*
